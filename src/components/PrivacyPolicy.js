    ...
    return (
      <div className="Instructions">
        ...
        <p>
          ...
          http://tactoe.bid (the &ldquo;Site&rdquo;).
        </p>
        ...
        <p>
          {" "}
          - &ldquo;Cookies&rdquo; are data files that are placed on your device
        ...
        <p>
          ...
          We also use device information for advertising.
        </p>
